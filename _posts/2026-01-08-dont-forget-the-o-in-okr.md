---
layout: post
title: "Don’t forget the O in OKR"
---

I’m a fan of the [OKR](https://en.wikipedia.org/wiki/Objectives_and_key_results) goal setting framework (nerd alert!). However, like any framework, it needs to be applied properly and is often misused. In this brief post I want to highlight a particular pattern that can limit the effectiveness of OKRs that I’ve repeatedly witnessed and how to mitigate it.
  
First, let’s talk about OKRs themselves. In my view, one of the most important things to remember when setting OKRs is that your objectives should be intentionally hard to quantify. (Yes, there will always be exceptions, but they should be few and far between.) They should describe a state of being, more like a vision statement. The Key Results, on the other hand, define how you can tell if you’ve reached your objective. That’s where the numbers come in. For more on this, check out Tability’s awesome [OKR guides](https://www.tability.io/okrs/what-are-okrs-definition).
  
So let’s assume you’ve set your team’s OKRs in this manner. Way to go! But you’re not done yet: one thing I have noticed over the years is that, once the OKRs are set, *the KRs take center stage*. The KR becomes the thing we are trying to achieve, the thing we talk about in meetings.
  
This is a dangerous situation. When we overindex on the KR itself, it’s easy to lose sight of what we are really trying to achieve. The KR isn’t what we’re trying to achieve, the Objective is! If all you focus on is the KR, then you may feel pressure to just to artificially move the number — [Goodhart’s Law](https://en.wikipedia.org/wiki/Goodhart's_law) in action. (Guardrail metrics help with this!)
